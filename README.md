...
|------------|-------------|----------|
| **ECOMMERCE CUSTOMER SALES ANALYSIS updated12 (1).docx** | Project documentation containing the problem statement, detailed cleaning steps, ER Diagram, and business recommendations. | Showcases documentation and storytelling skills. |
| **ecommerce_customer_sales_dirty.csv** | Raw dataset before cleaning and transformation. | Demonstrates handling of messy data. |
...
**Shadin K**  
*Data Analyst | SQL | BI & Power Query Enthusiast*  
📧 [your-email@example.com]  
🌐 [LinkedIn or Portfolio URL]  

---

📌 *This project demonstrates end-to-end SQL data pipeline development, normalization (3NF), and BI-driven insights for e-commerce decision-making.*
